      ...
      <div className="space-y-12">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="lead text-muted-foreground">
            ...
            rộng và phát triển trên nhiều lĩnh vực, bao gồm hợp tác quốc tế, học
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg max-w-none">
            <p>
              Hợp tác với các tổ chức, trường đại học và doanh nghiệp nước ngoài
              để hỗ trợ nghiên cứu khoa học sinh viên, trao đổi học thuật và
              thúc đẩy đổi mới sáng tạo. Các chương trình chính bao gồm:
            </p>
            <ul className="space-y-4">
              ...
              <li>
                Tham gia hội thảo và sự kiện quốc tế về công nghệ và nghiên cứu
                khoa học, tạo cơ hội kết nối và hợp tác xuyên biên giới.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg max-w-none">
            <p>
              ...
              trung tâm đào tạo nhằm nâng cao chất lượng nghiên cứu khoa học của
              sinh viên.
            </p>
          </div>
        </section>
